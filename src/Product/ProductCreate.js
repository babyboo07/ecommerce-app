      ...
      <div className="pt-4">
        ...
        >
          ...
          <Form.Item
            name="cateId"
            label="Category"
            rules={[{ required: true, message: "Plesse select your Category" }]}
          >
            <Select placeholder="Select Category" onChange={(e) => setCategoryList(e)}>
              {categories ? (
                categories.map((cl) => {
                  return (
